...
const JobCard = ({ job }: iAppProps) => {
  return (
    <Link href={`/job/${job.id}`}>
      <Card className="hover:bg-primary/10 hover:border-primary relative shadow-none transition-all duration-300 ">
        <CardHeader>
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex flex-col gap-[5px] flex-grow">
              <h1 className="text-xl md:text-2xl font-bold mt-[-3px]">
                {job.jobTitle}
              </h1>
